...
public class RecipeStepsTest {
    ...
    public void recipeStepsTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.Recipe_name), withText("Ingredients"),
                        childAtPosition(
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.Recipe_name), withText("Recipe Introduction"),
                        childAtPosition(
                                allOf(withId(R.id.card_view),
                                        childAtPosition(
                                                IsInstanceOf.<View>instanceOf(android.widget.LinearLayout.class),
        ...
        ViewInteraction textView3 = onView(
                allOf(withId(R.id.Recipe_name), withText("Starting prep"),
                        childAtPosition(
                                allOf(withId(R.id.card_view),
                                        childAtPosition(
                                                IsInstanceOf.<View>instanceOf(android.widget.LinearLayout.class),
        ...
        ViewInteraction textView4 = onView(
                allOf(withId(R.id.Recipe_name), withText("Prep the cookie crust."),
                        childAtPosition(
                                allOf(withId(R.id.card_view),
                                        childAtPosition(
                                                IsInstanceOf.<View>instanceOf(android.widget.LinearLayout.class),
        ...
        ViewInteraction textView5 = onView(
                allOf(withId(R.id.Recipe_name), withText("Prep the cookie crust."),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView5.check(matches(withText("Prep the cookie crust.")));
